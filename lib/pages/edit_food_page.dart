...
import '../view_models/edit_food_model.dart';
...
class EditFoodPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    foodVM.foodNameController.value =
        TextEditingController(text: doc['foodName']);
    foodVM.timeController.value = TextEditingController(text: doc['time']);
    foodVM.notesController.value = TextEditingController(text: doc['notes']);
    foodVM.reminderTimeController.value =
        TextEditingController(text: doc['reminderTime']);
    foodVM.day.value = doc['day'];
    return Scaffold(
      body: SafeArea(
          child: Container(
                ...
                children: [
                  ...
                  Obx(
                    () => PrimartyButton(
                        ...
                        height: 10,
                        onTap: () async {
                          await foodVM.editFood(doc['foodId']);
                        },
                        icon: ''),
                  ),
                  const SizedBox(
