...
class FoundProfilePage extends StatefulWidget {
  const FoundProfilePage({super.key});

  @override
  State<FoundProfilePage> createState() => _FoundProfilePageState();
}

class _FoundProfilePageState extends State<FoundProfilePage> {
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            //   children: [
                            //     Image.asset(AssetImages.somePhoto),
                            //     Image.asset(AssetImages.somePhoto),
                            //     Image.asset(AssetImages.somePhoto),
                            //   ],
                            // ),
