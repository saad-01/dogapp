...
class ForgetModel extends GetxController {
  ...
  Future<void> loginUser() async {
    ...
    if (emailController.value.text.isNotEmpty && valid) {
      String res = '';
      await AuthMethods()
          .sendPasswordResetEmail(emailController.value.text.trim());
      loading.value = false;
      Get.back();
      Utils.snackBar(AppStrings.success.tr, AppStrings.checkMail.tr);
      // if (res == 'success') {
